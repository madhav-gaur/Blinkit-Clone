...
const LargeViewImage = ({ selectedImage,  productData, setSelectedImage, mouseEvent, close }) => {
    ...
    return (<>
        {/* <div className='main-product-image-wrapper'>
            ...
            <div className='main-product-image-show'>
        ...
        <div className='product-large-view-wrapper'>
            <div className='product-large-view-container'>
                <div className='large-view-img'>
                    {selectedImage && <img src={selectedImage} alt="Product Preview" />}
                </div>
                <div className='large-view-details'>
                    <h2>
                        {productData.name}
                    </h2>
                    <div className='large-view-image-gallery-wrapper'>
                        {productData.image.map((img, index) => (
                            <img
                            onMouseEnter={mouseEvent === 'hover' ? () => setSelectedImage(img) : undefined}
                            onClick={mouseEvent === 'click' ? () => setSelectedImage(img) : undefined}
                ...
                <button onClick={close} className='large-view-close-btn'><IoClose/></button>
            </div>
        </div>
    </>
    )
